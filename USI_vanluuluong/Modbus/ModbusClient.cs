...
namespace Baodongchem
{
    ...
    public partial class ModbusClient
    {
        ...
        public void Connect()
        {
            try
            {
                ...
                if (!udpFlag)
                {
                    ...
                    if (!success)
                    { 
                        // EasyModbus.Exceptions.ConnectionException("connection timed out");
                        // MessageBox.Show("connection timed out PLC_LS");
                    }
        ...
        /// <param name="off">First Register containing the String to convert</param>
